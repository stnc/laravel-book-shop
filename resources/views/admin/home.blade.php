                ...
                <div class="card card-small mb-3">
                    <div class="card-body">
                        <form class="add-new-post">
                            ...
                            @extends('admin.partials.tinymce')
                        </form>
                    </div>
                </div>
                <!-- / Add New Post Form -->
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item p-3">
                                ...
                                <span class="d-flex mb-2"><i class="material-icons mr-1">visibility</i><strong
                                        ...
                                        class="text-success">Public</strong> <a class="ml-auto" href="#">Edit</a></span>
                                <span class="d-flex mb-2"><i class="material-icons mr-1">calendar_today</i><strong
                                        class="mr-1">Schedule:</strong> Now <a class="ml-auto" href="#">Edit</a></span>
                            ...
                            <li class="list-group-item d-flex px-3">
                                <button class="btn btn-sm btn-outline-accent"><i class="material-icons">save</i> Save
                                    Draft
                                </button>
                                <button class="btn btn-sm btn-accent ml-auto"><i class="material-icons">file_copy</i>
                                    Publish
                                </button>
                            </li>
                        </ul>
