    ...
    <!-- Page Header -->
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                {!! Form::open(array('route' => 'posts.store',  'class' => 'form-control add-new-post', "id"=>"formId", 'files'=>'true','method'=>'POST')) !!}
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('tags', null, array('placeholder' => 'Tags','class' => 'form-control form-control-lg mb-3')) !!}
                                </div>
