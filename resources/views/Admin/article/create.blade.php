...
<section class="content">
    ...
    <form action="{{url($prefix)}}" method="post" enctype="multipart/form-data">
        {!! csrf_field() !!}
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="images[]"
                                                                               ...
                                                                               onclick="openKCFinder_singleFile('Images',this);">
                                                                        ...
                                                                        <select name="categories[]" class="form-control select2" multiple="multiple"
                                                                            ...
                                                                            @foreach($categories as $cat)
                                                                                ...
                                                                                @foreach($cat->children as $child)
                                                                                    <option value="{{$child->id}}"> {{$cat->title}} > {{$child->title}}</option>

                                                                                    @foreach($child->children as $subchild)

                                                                                        <option value="{{$subchild->id}}">{{$cat->title}} > {{$child->title}}
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="files[]"
                                                                               placeholder="yazıya pdf excel yüklemek için tıklayınız." class="form-control"
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label>
                                                                            <input type="radio" name="active" value="0" class="flat-red">
                                                                            Passive
                                                                        </label>
                                                                    </div>
