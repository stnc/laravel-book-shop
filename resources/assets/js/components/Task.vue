                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-bordered table-striped table-responsive" v-if="tasks.length > 0">
                                ...
                                <tr v-for="(task, index) in tasks">
                                    ...
                                    <td>
                                        <button @click="initUpdate(index)" class="btn btn-success btn-xs" style="padding:8px"><span class="glyphicon glyphicon-edit"></span>
                                        </button>

                                        <button @click="deleteTask(index)" class="btn btn-danger btn-xs" style="padding:8px"><span class="glyphicon glyphicon-trash"></span>
                                        </button>
